...
export const CarDetailsPage = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 pb-12">
      ...
      <section className="grid lg:grid-cols-[1.15fr_0.85fr] gap-6 mt-8">
        <div className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5">
            ...
            <div className="mt-3 grid grid-cols-3 gap-2">
              {galleryImages.slice(0, 3).map((image, index) => (
                <button
                  ...
                  className={`rounded-lg overflow-hidden border-2 transition ${activeImageIndex === index
                    ? "border-cyan-500"
          ...
          <div className="mt-5 rounded-xl border border-slate-200 p-4 bg-slate-50">
            ...
            <div className="mt-3 h-36 w-full overflow-hidden rounded-lg border border-slate-200 bg-slate-50">
              <img
            ...
            {relatedCars.map((item) => {
              ...
              return (
                <article key={item._id} className="rounded-2xl border border-slate-200 bg-white overflow-hidden">
                  <div className="h-36 w-full overflow-hidden rounded-lg bg-slate-50">
                    <img
                      src={relatedImage}
