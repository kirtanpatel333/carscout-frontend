      ...
      >
        ...
        <div className="max-h-[80vh] overflow-y-auto p-5 sm:p-6">
          <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-5">
            <div>
              <div className="h-64 sm:h-72 w-full overflow-hidden rounded-2xl border border-slate-200 bg-slate-50">
                <img
                  src={imageUrl}
                ...
                <div className="grid gap-2 mt-3">
                  ...
                  <div className="grid grid-cols-2 gap-2 pt-1">
                    <a
                      ...
                      className={`text-center rounded-lg px-3 py-2 text-xs font-semibold ${hasEmail
                    ...
                    <a
                      ...
                      className={`text-center rounded-lg px-3 py-2 text-xs font-semibold ${hasPhone
                          ? "bg-white border border-cyan-200 text-cyan-800 hover:bg-cyan-100"
                          : "bg-slate-100 border border-slate-200 text-slate-400 cursor-not-allowed"
                        }`}
                    >
